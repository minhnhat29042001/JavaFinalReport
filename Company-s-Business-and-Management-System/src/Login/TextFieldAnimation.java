...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/Login/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/login/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/Login/loading.gif"));
